# Problem 1: Print the multiplication table of a given number

# Get input from the user.

# Use a for loop to multiply the number by values from 1 to 10.

    # Print the result in the format "number * i = result".
